...
Config.MenuItems = {
        ...
        {
            {
                ...
                id = 'house',
                title = 'Options de la maison',
                icon = 'home',
                items = {
                    {
                        id = 'givehousekey',
                        title = 'Donner des clés',
                        icon = 'key',
                        type = 'client',
                ...
                id = 'givenum',
                title = 'Donner le contact',
                icon = 'id-card',
                type = 'client',
                event = 'qs-smartphone:server:GiveContactDetails',
                shouldClose = true
            }, 
        ...
        items = {
            {
                ...
                icon = 'shopping-bag',
                type = 'client',
                event = 'inventory:server:RobPlayer',
                shouldClose = true,
            }
        }
    },
    ...
    [5] = {
        ...
        items = {
            {
                id = 'emote',
                title = 'Ouvrir menu E-mote',
                icon = 'walking',
                type = 'client',
                event = 'animations:client:EmoteMenu',
                shouldClose = true
            },  {
                id = 'walkstyles',
                title = 'Style de marche',
                icon = 'walking',
                items = {
                    {
                        id = 'alien',
    ...
    ["taxi"] = {
        {
            ...
            icon = 'store',
            type = 'client',
            event = 'QBCore:Client:SetDuty',
            shouldClose = true
        }, {
            id = 'npc_mission',
            title = 'Démarrer missions/Civiles',
            icon = 'taxi',
            type = 'client',
    ...
    ["bus"] = {
        {
            ...
            icon = 'toggle-on',
            type = 'client',
            event = 'qb-busjob:client:DoBusNpc',
            shouldClose = true
        }
    },
    ["garbage"] = {
    ...
    ["police"] = {
        {
            ...
            id = 'resetcar',
            title = 'Forcé la serrure de la Voiture',
            icon = 'key',
            type = 'client',
            event = 'qb-policejob:client:openLockedCar',
            shouldClose = true
        },{
            id = 'stoptraffic',
            title = 'Arreté le traffic',
            icon = 'car',
            type = 'client',
            ...
            id = 'resethouse',
            title = 'Forcé la serrure de la maison',
            icon = 'key',
            type = 'client',
            ...
            title = 'Retirer permis de conduire',
            icon = 'id-card',
            type = 'client',
...
Config.Commands = {
    ["top"] = {
        ...
        Sprite = "top",
        Desc = "Enlevez ou remettez votre chemise",
        Button = 1,
        Name = "Torso"
    },
    ["gloves"] = {
        ...
        Sprite = "gloves",
        Desc = "Enlevez ou mettez vos gants",
        Button = 2,
        Name = "Gloves"
    },
    ["visor"] = {
    ...
    ["shoes"] = {
        ...
        Sprite = "shoes",
        Desc = "Enlevez et mettez vos chaussures",
        Button = 5,
        Name = "Shoes"
    },
    ["vest"] = {
        ...
        Sprite = "vest",
        Desc = "Enlevez et mettez votre gilet",
        Button = 14,
        Name = "Vest"
    },
    ["hair"] = {
        ...
        Sprite = "hair",
        Desc = "Relevez ou abaissez vos cheveux, faites un chignon ou une queue de cheval.",
        Button = 7,
        Name = "Hair"
    },
    ["hat"] = {
    ...
    ["glasses"] = {
        ...
        Sprite = "glasses",
        Desc = "Enlevez et mettez vos lunettes",
        Button = 9,
        Name = "Glasses"
    },
    ["ear"] = {
        ...
        Sprite = "ear",
        Desc = "Enlevez ou mettez votre accessoire d'oreille",
        Button = 10,
        Name = "Ear"
    },
    ["neck"] = {
        ...
        Sprite = "neck",
        Desc = "Enlevez et mettez votre accessoire de cou",
        Button = 11,
        Name = "Neck"
    },
    ["watch"] = {
        ...
        Sprite = "watch",
        Desc = "Enlevez ou remettez votre montre",
        Button = 12,
        Name = "Watch",
        Rotation = 5.0
    },
    ["bracelet"] = {
        ...
        Sprite = "bracelet",
        Desc = "Enlevez et mettez votre bracelet",
        Button = 13,
        Name = "Bracelet"
    },
    ["mask"] = {
        ...
        Sprite = "mask",
        Desc = "Enlevez et mettez votre masque",
        Button = 6,
        Name = "Mask"
    }
}
...
Config.ExtraCommands = {
    ["pants"] = {
        ...
        Sprite = "pants",
        Desc = "Enlevez ou remettez votre pantalon",
        Name = "Pants",
        OffsetX = -0.04,
        OffsetY = 0.0
    },
